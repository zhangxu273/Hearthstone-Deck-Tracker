...
namespace HDT.Core.HsReplay
{
	internal class ApiWrapper
	{
...
#endif
		private static readonly HsReplayClient Client = new HsReplayClient("089b2bc6-3c26-4aab-adbe-bcfd5bb48671", UserAgentName + "/" + Helper.AppVersion, config: TryGetConfig());
		...
		{
			var file = Helper.GetFile("hsreplaynet.xml");
			if(!file.Exists)
				return null;
			try
			{
